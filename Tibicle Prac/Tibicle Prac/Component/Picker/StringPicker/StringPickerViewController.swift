...
class StringPickerViewController: NSObject
{
    ...
    var viewBtnsColor: UIColor = .white
    var pickerViewColor: UIColor = .white
    var btnDoneTitleFont: UIFont = .boldSystemFont(ofSize: 12)
    var btnCancelTitleFont: UIFont = .boldSystemFont(ofSize: 12)
    var btnDoneTitleColor:UIColor = .blue
    var btnCancelTitleColor:UIColor = .blue
    var btnDoneTitle: String = "Done"
    var btnCancelTitle: String = "Cancel"
    ...
    func show(onVC: UIViewController?) {
        ...
        //btnCancelTitleColor = .customSubtitle
        //btnCancelTitleFont = .regularValueFont
        btnDoneTitle = "Done"
        //btnDoneTitleColor = .customBlue
        //btnDoneTitleFont = .regularValueFont
        ...
        if (onVC != nil) {
            ...
            slideInTransitioningDelegate.ratio = (viewHeight + barBtnHeight + bottomMarginFromSafeArea)/UIScreen.main.bounds.size.height
